...
class RestrictCategories{
	...
	public function cat_filters( $categories ){
		...
		if ( $this->cat_list !== '' ) {
			...
			if ( in_array( $pagenow, $pages ) || ( $pagenow == 'edit-tags.php' && $_GET['taxonomy'] == 'category' ) )
                        ...
                        <div class="inside" style="padding:0 10px;">
							<div class="taxonomydiv">
                            	<ul id="taxonomy-category-tabs" class="taxonomy-tabs add-menu-item-tabs">
                                	<li<?php echo ( 'all' == $current_tab ? ' class="tabs"' : '' ); ?>><a href="<?php echo add_query_arg( array( 'type' => 'users', $id . '-tab' => 'all' ), $roles_tab ); ?>" class="nav-tab-link">View All</a></li>
